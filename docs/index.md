...
<LinkCard :link="{ name: 'Quick Start', url: '/docs/quick-start', image: '/background/bgbtn.jpg', description: 'Install, run, and understand the project structure.' }" />
...
<LinkCard :link="{ name: 'Blogging Guide', url: '/docs/blogging', image: '/background/bg.jpg', description: 'Write posts with frontmatter, BlogCards, and Markdown.' }" />
<LinkCard :link="{ name: 'Component Reference', url: '/docs/components', image: '/background/hero-bg.jpg', description: 'Explore all Pixel UI and layout components with live demos.' }" />
